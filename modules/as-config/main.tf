...
resource "tencentcloud_as_scaling_config" "as_config" {
  ...
  image_id           = var.enable_image_family ? null : try(data.tencentcloud_images.this[0].images[0].image_id)
  ...
  internet_charge_type       = var.internet_charge_type # "TRAFFIC_POSTPAID_BY_HOUR"
  ...
  host_name_settings {
    ...
    host_name_style = var.host_name_style # "UNIQUE"
  }

  instance_name_settings {
    instance_name       = var.instance_name
    instance_name_style = var.instance_name_style # "UNIQUE"
  }
